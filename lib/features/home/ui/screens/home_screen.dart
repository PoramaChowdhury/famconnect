  ...
  void _onNavBarTapped(int index) {
    ...
    switch (index) {
      case 0:
        break;
      case 1:
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => EventCreateScreen()));
        break;
      case 2:
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => FamilyChatScreen()));
        break;
      case 3:
                  ...
                  switch (index) {
                    case 0:
                      return GridViewItem(
                        ...
                        label: 'Schedule',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => UserScheduleScreen())),
                      );
                    case 1:
                      return GridViewItem(
                        icon: Lottie.asset(AssetsPath.scheduleIcon, height: 70, width: 70),
                        label: 'Find My Family',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => FamilyMemberTrackingScreen())),
                      );
                    case 2:
                      return GridViewItem(
                        icon: Lottie.asset(AssetsPath.scheduleIcon, height: 70, width: 70),
                        ...
                        onTap: () {
                          final user = FirebaseAuth.instance.currentUser;
                          if (user != null) {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => FamilyMapScreen(userId: user.uid)));
                          }
                        },
                      );
                    case 3:
...
// >>>>>>> master
                    ...
                    case 6:
                      return GridViewItem(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => AllUsersFreeTimeScreen())),
                      );
                    default:
                      return const SizedBox.shrink();
                  }
